...
Однако с реализацией более серьезных приложений, использующих базу данных или Servlet API, становится понятно, что 
...
помня лишь о необходимости расставлять над классами аннотации и не забывать добавлять пакеты, которые требуется 
...
- Статические методы. Логика, по которой выбирается такой подход, тоже очевидна, понятна и, что самое страшное, 
  ...
  раскрывается в более сложных системах, при необходимости гибко подменять одни реализации другими или же 
...
Прежде чем разбирать именно механизм внедрения зависимостей, нужно прояснить саму логику использования термина 
