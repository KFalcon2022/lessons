...
- Netflix Eureka. Реализация discovery-сервиса, разработанная Netflix и интегрированная в Spring Cloud. При 
  ...
  discovery-серверу. Discovery-сервер, в свою очередь, запоминает адреса и другие данные приложений и сообщает их по
  мере необходимости. Таким образом каждое приложение получает от discovery-сервера информацию об актуальных адресах
  остальных приложений, к которым собирается отправлять HTTP-запросы;
