...
контракта обрабатывать определенные ошибки через механизм проверяемых исключений и `throws`. Казалось бы, что еще нужно
для счастья?  
...
В зависимости от стека технологий и конкретной реализации именно обработчика можно создать различные синтаксические 
