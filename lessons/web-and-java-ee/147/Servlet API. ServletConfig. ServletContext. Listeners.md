...
класса. Последнее, собственно, и отдается на откуп `ServletConfig`. Это разделение отчасти искусственное, но часто
...
1. Есть основная сущность с определенным методом логики (далее - _МЛ_). Именно вызов данного метода и служит триггером 
