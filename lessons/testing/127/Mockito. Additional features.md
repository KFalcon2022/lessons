...
поведения объектов. Но вполне допустима ситуация, когда требуется имитировать поведение статического метода, который
...
1. Legacy-код, без инверсии управления и/или обилия статических методов с бизнес-логикой. Надеюсь, что это
