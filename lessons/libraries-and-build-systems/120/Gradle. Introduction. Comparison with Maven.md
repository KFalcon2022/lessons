...
Как видите, ничего сложного нет. Лишь пачка файлов для Gradle Wrapper, которые нас не интересуют на данном этапе, и два
...
В рамках пункта предлагаю разобрать проект по ссылке:
...
схожую функциональность. Это касается и понятия модуля для реализации многомодульных приложений, и профилей для 
