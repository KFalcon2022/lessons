...
>
> В рамках курса мы не будем слишком углубляться в то, какими объектами оперирует Gradle в своем внутренней
...
рамках проекта или группы проектов пишутся и поддерживаются собственные плагины, решающие узкие задачи сборки.
